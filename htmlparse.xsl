...
<!--
 this is an adaption of https://github.com/davidcarlisle/web-xslt/blob/main/htmlparse/htmlparse.xsl:
 HTML Parser in XSLT2 Copyright 2004-2009 David Carlisle 
 Distribution, use and modification of this code permitted so long as original is cited.
-->
...
<xsl:function  name="d:htmlparse" visibility="public">
